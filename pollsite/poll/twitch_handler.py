...
#### INIT AND AUTHENT ####
	...
	async def start_chat(self):
		...
		self.event_sub = EventSub("https://live.pour-info.tech:50443", self.twitch_api.client_id, 50444, self.twitch_new) # test webhook
		self.event_sub.host = '127.0.0.1' # not listening on every host, only on localhost:50444
